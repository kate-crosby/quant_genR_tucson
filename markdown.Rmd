...
Could we use our indexing technique from the phenotypic correlations to get an idea. On your own see if you can print a small subset of the object to get an idea of its structure.
...
We don't know much about this dataset
